    ...
    <footer className="border-t border-border/40 bg-background">
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 py-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-semibold">
                SkillSprint <span className="text-indigo-500">AI</span>
              </span>
            </Link>
            <p className="text-sm text-muted-foreground mb-4 max-w-xs leading-relaxed">
              AI-powered skill marketplace connecting learners with expert mentors for personalized growth.
            </p>
        ...
        <div className="mt-12 pt-6 border-t border-border/40 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} SkillSprint AI. All rights reserved.</p>
